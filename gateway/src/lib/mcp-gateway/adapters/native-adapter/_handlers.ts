// ─── Zenic-Agents v3 — Native Executor Schema Definitions ──────────────
// Schema definitions, types, and input schemas for the 19 Zenic executors.
// Extracted from native-adapter.ts for modularity.

import type { SdkToolConfig } from "../../sdk/types";
...
export interface ExecutorSchemaDef {
...
export const EXECUTOR_SCHEMAS: Record<ZenicExecutorType, ExecutorSchemaDef> = {
  http_request: {
