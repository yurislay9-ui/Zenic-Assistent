...
function mapTraceRecord(raw: { id: string; traceId: string; sessionId: string | null; decisionId: string | null; tenantId: string | null; rootSpanId: string | null; status: string; verdict: string | null; duration: number | null; spanCount: number; serviceName: string; attributes: string; createdAt: Date; completedAt: Date | null }): TraceRecord {
  return {
    id: raw.id,
    traceId: raw.traceId,
...
function mapSpanRecord(raw: { id: string; spanId: string; traceId: string; parentSpanId: string | null; name: string; kind: string; status: string; statusMessage: string | null; startTime: Date; endTime: Date | null; duration: number | null; service: string; resource: string | null; resourceId: string | null; action: string | null; outcome: string | null; attributes: string; events: string; links: string; createdAt: Date }): SpanRecord {
  return {
    id: raw.id,
    spanId: raw.spanId,
    traceId: raw.traceId,
