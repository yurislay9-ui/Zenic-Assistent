...
class YamilAgent(BaseAgent[YamilResult]):
    ...
    def _fallback_niche_list() -> List[YamilNicheInfo]:
        ...
        return [
            YamilNicheInfo("ai_automation", "Automatización IA", "ai_data", "Automatización inteligente con IA", "high", "enterprise", ["GDPR", "SOC2"]),
            YamilNicheInfo("data_analytics", "Análisis de Datos", "ai_data", "Plataforma de análisis de datos", "medium", "large", ["GDPR"]),
            YamilNicheInfo("ml_operations", "Operaciones ML", "ai_data", "Plataforma de operaciones ML", "high", "enterprise", ["GDPR", "SOC2"]),
            YamilNicheInfo("nlp_services", "Servicios PLN", "ai_data", "Plataforma de procesamiento de lenguaje natural", "medium", "large", ["GDPR"]),
            YamilNicheInfo("defi_protocols", "Protocolos DeFi", "fintech", "Finanzas descentralizadas", "critical", "enterprise", ["AML", "KYC", "SEC"]),
            YamilNicheInfo("neo_banking", "Banca Digital", "fintech", "Banca digital y pagos", "critical", "enterprise", ["PCI-DSS", "AML", "KYC", "SOX"]),
            YamilNicheInfo("insurtech", "Tecnología Aseguradora", "fintech", "Seguros digitales con IA", "critical", "large", ["GDPR", "Solvency II", "AML"]),
            YamilNicheInfo("regtech", "Tecnología Regulatoria", "fintech", "Cumplimiento regulatorio automatizado", "critical", "enterprise", ["GDPR", "SOX", "AML", "Basel III"]),
            YamilNicheInfo("telemedicine", "Telemedicina", "healthtech", "Consultas médicas virtuales", "critical", "large", ["HIPAA", "GDPR"]),
            YamilNicheInfo("mental_health_ai", "IA de Salud Mental", "healthtech", "Salud mental asistida por IA", "critical", "large", ["HIPAA", "GDPR", "APA"]),
            YamilNicheInfo("genomics", "Genómica", "healthtech", "Análisis genómico y farmacogenómica", "critical", "enterprise", ["HIPAA", "GINA", "GDPR"]),
            YamilNicheInfo("wearables_health", "Salud con Wearables", "healthtech", "Monitoreo de salud con wearables", "high", "large", ["HIPAA", "FDA", "GDPR"]),
            YamilNicheInfo("carbon_tracking", "Seguimiento de Carbono", "greentech", "Seguimiento de huella de carbono", "medium", "large", ["GHG Protocol", "TCFD"]),
            YamilNicheInfo("smart_grid", "Red Eléctrica Inteligente", "greentech", "Gestión de red eléctrica inteligente", "high", "enterprise", ["NERC", "IEC 61850"]),
            YamilNicheInfo("circular_economy", "Economía Circular", "greentech", "Plataforma de economía circular", "medium", "large", ["EU Circular Economy"]),
            YamilNicheInfo("adaptive_learning", "Aprendizaje Adaptativo", "edtech", "Aprendizaje personalizado con IA", "medium", "large", ["FERPA", "COPPA"]),
            YamilNicheInfo("vr_education", "Educación en RV", "edtech", "Educación en realidad virtual", "medium", "large", ["FERPA", "COPPA"]),
            YamilNicheInfo("micro_credentials", "Microcredenciales", "edtech", "Certificaciones digitales verificables", "medium", "medium", ["FERPA"]),
            YamilNicheInfo("smart_buildings", "Edificios Inteligentes", "proptech", "Gestión de edificios con IoT", "high", "large", ["BREEAM", "LEED"]),
            YamilNicheInfo("digital_twins", "Gemelos Digitales", "proptech", "Simulación con gemelos digitales", "high", "enterprise", ["ISO 23247"]),
            YamilNicheInfo("fractional_ownership", "Propiedad Fraccional", "proptech", "Tokenización de propiedad inmobiliaria", "critical", "large", ["SEC", "AML", "KYC"]),
            YamilNicheInfo("smart_contracts", "Contratos Inteligentes", "legaltech", "Contratos inteligentes en blockchain", "critical", "enterprise", ["SEC", "eIDAS"]),
            YamilNicheInfo("legal_ai", "IA Jurídica", "legaltech", "Asistente jurídico con IA", "critical", "large", ["GDPR", "ABA", "SOX"]),
            YamilNicheInfo("compliance_automation", "Automatización de Cumplimiento", "legaltech", "Cumplimiento regulatorio automatizado", "critical", "enterprise", ["SOX", "GDPR", "ISO 27001"]),
        ]
