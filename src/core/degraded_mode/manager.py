"""Degraded Mode / Paralysis System (Phase 6.4)

Modes: NORMAL(0) → DEGRADED(1) → PARALYSIS_1(2) → PARALYSIS_2(3)
Persistence via DegradationPersistence; types from types.py.
"""
...
# ── Feature restriction maps by DegradationLevel ──────────

_FEATURE_RESTRICTIONS: Dict[DegradationLevel, List[str]] = {
    DegradationLevel.NORMAL: [],
    DegradationLevel.DEGRADED: [
        "executor_run", "api_mutate", "dashboard_write",
        "send_email", "create_invoice", "process_payment", "schedule",
    ],
    DegradationLevel.PARALYSIS_1: [
        "write", "delete", "manage", "send", "create",
        "process", "api_mutate", "executor_run", "schedule",
    ],
    DegradationLevel.PARALYSIS_2: [
        "write", "delete", "manage", "send", "create",
        "process", "api", "schedule", "dashboard",
    ],
}
